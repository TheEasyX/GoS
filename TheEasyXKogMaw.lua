...
AutoUpdater(LocalVersion, 
 ...
 "/jonnyboy19/GoS/master/TheEasyXKogMaw.ver.lua".. "?no-cache=".. math.random(9999, 1001020201), 
 "/jonnyboy19/GoS/master/TheEasyXKogMaw.lua".. "?no-cache=".. math.random(9999, 1001020201), 
